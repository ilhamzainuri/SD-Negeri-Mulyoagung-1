                ...
                <div>
                    ...
                    <div className="p-6 border-b border-slate-800 flex items-center gap-3">
                        ...
                        <div className="overflow-hidden">
                            ...
                            <span className={`text-[10px] uppercase font-bold tracking-wide px-2 py-0.5 rounded-full ${user.role === 'ADMIN' ? 'bg-indigo-900/60 text-indigo-300 border border-indigo-700/50' : 'bg-amber-900/60 text-amber-300 border border-amber-700/50'
                                }`}>
                                {user.role}
                            </span>
                        </div>
                    ...
                    <nav className="p-4 space-y-1.5">
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all cursor-pointer ${activeTab === 'guru' ? 'bg-teal-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all cursor-pointer ${activeTab === 'berita' ? 'bg-teal-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200'
                                }`}
                        >
                        ...
                        {user.role === 'ADMIN' && (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all cursor-pointer ${activeTab === 'verifikasi' ? 'bg-teal-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200'
                                    }`}
                            >
                        ...
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all cursor-pointer ${activeTab === 'user' ? 'bg-teal-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200'
                                }`}
                        >
