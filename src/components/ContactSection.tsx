      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 space-y-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-xl border border-white/60 space-y-6 flex flex-col justify-between">
              <div>
          ...
          {/* Right: Form Pengaduan & Map Preview */}
          <div className="lg:col-span-7 space-y-8">
            {/* Form Pengaduan Card */}
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-xl border border-white/60">
            ...
            {/* Map Preview Card */}
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 sm:p-6 shadow-xl border border-white/60 overflow-hidden flex flex-col justify-between">
              ...
              <div className="w-full h-64 sm:h-72 rounded-2xl overflow-hidden bg-slate-200 relative">
                <iframe
